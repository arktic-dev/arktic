...
var action_register = function (current_id, action_name, current_audio_time) {
  $.post("/transcription/action/", {job_id:$('#job').attr('job_id'),transcription_id:current_id,audio_time:current_audio_time,action_name:action_name,csrfmiddlewaretoken:'rAsyYbQY0R43mOKXBH0IdUMhlza8AQaO'})
  .done(function(revision_id) {
    if (action_name=='tick') { //revision complete
      ...
      if (utterance.length!=0) {
        $.post("/transcription/revision/", {revision_id:revision_id,utterance:utterance.join(' '),audio_time:current_audio_time,csrfmiddlewaretoken:'rAsyYbQY0R43mOKXBH0IdUMhlza8AQaO'});
      }
    }
  });
}
var add_word = function (current_id, word) {
  $.post("/transcription/add/", {transcription_id:current_id,word:word,csrfmiddlewaretoken:'rAsyYbQY0R43mOKXBH0IdUMhlza8AQaO'});
}
