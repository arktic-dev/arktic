...
$(document).ready(function() {
    ...
    var states = ["", "u", "i", "l", "k", "e", "b", "a", "j", "m", "v", "n", "y", "p", "w", "r", "d", "c", "x", "h", "t", "g", "f", "of", "it", "is", "my", "oh", "to", "an", "no", "as", "in", "on", "me", "all", "one", "two", "six", "yet", "yes", "the", "for", "egg", "i'd", "cat", "zero", "five", "it's", "nine", "four", "have", "that", "lima", "need", "talk", "know", "dash", "golf", "want", "papa", "kilo", "like", "hear", "pence", "eight", "three", "don't", "seven", "agent", "slash", "speak", "alpha", "wanna", "delta", "tango", "human", "minus", "sorry", "tommy", "hotel", "eddie", "bravo", "didnt", "keith", "dunno", "hello", "pounds", "thirty", "twenty", "please", "repeat", "person", "number", "nought", "triple", "double", "pardon", "that's", "treble", "dennis", "london", "hyphen", "stroke", "juliet", "pinner", "forest", "sixteen", "advisor", "someone", "account", "oblique", "charlie", "service", "reedham", "waltham", "arsenal", "station", "operator", "somebody", "customer", "services", "umbrella", "deptford", "hello my", "canonbury", "specialist", "teddington", "hackbridge", "barnehurst", "wandsworth", "[hesitation]", "hello my name is"];
    $('#typeahead').typeahead({
      hint: true,
      highlight: true,
      minLength: 1
