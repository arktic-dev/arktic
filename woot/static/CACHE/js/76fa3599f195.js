...
var action_register = function (current_id, action_name, current_audio_time) {
  $.post("/transcription/action/", {job_id:$('#job').attr('job_id'),transcription_id:current_id,audio_time:current_audio_time,action_name:action_name,csrfmiddlewaretoken:'CxEFXbcnzBC4iLKfVnT51f0AdVMAAWEy'})
  .done(function(revision_id) {
    if (action_name=='tick') { //revision complete
      ...
      if (utterance.length!=0) {
        $.post("/transcription/revision/", {revision_id:revision_id,utterance:utterance.join(' '),audio_time:current_audio_time,csrfmiddlewaretoken:'CxEFXbcnzBC4iLKfVnT51f0AdVMAAWEy'});
      }
    }
  });
}
var add_word = function (current_id, word) {
  $.post("/transcription/add/", {transcription_id:current_id,word:word,csrfmiddlewaretoken:'CxEFXbcnzBC4iLKfVnT51f0AdVMAAWEy'});
}
...
$(document).ready(function() {
    ...
    var states = ["", "u", "i", "l", "k", "e", "b", "a", "j", "m", "v", "n", "y", "p", "w", "r", "d", "c", "x", "h", "t", "g", "f", "of", "it", "is", "my", "oh", "to", "an", "no", "as", "in", "on", "me", "all", "one", "two", "six", "yet", "yes", "the", "for", "egg", "i'd", "cat", "zero", "five", "it's", "nine", "four", "have", "that", "lima", "need", "talk", "know", "dash", "golf", "want", "papa", "kilo", "like", "hear", "pence", "eight", "three", "don't", "seven", "agent", "slash", "speak", "alpha", "wanna", "delta", "tango", "human", "minus", "sorry", "tommy", "hotel", "eddie", "bravo", "didnt", "keith", "dunno", "pounds", "thirty", "twenty", "please", "repeat", "person", "number", "nought", "triple", "double", "pardon", "that's", "treble", "dennis", "london", "hyphen", "stroke", "juliet", "pinner", "forest", "sixteen", "advisor", "someone", "account", "oblique", "charlie", "service", "reedham", "waltham", "arsenal", "station", "operator", "somebody", "customer", "services", "umbrella", "deptford", "sflskdfj", "sdfkjsdf", "canonbury", "specialist", "teddington", "hackbridge", "barnehurst", "wandsworth", "[hesitation]"];
    $('#typeahead').typeahead({
      hint: true,
      highlight: true,
      minLength: 1
...
$(document).ready(function() {
  ...
  $('button.common').click(function(){
    var transcription_id = $(this).attr('transcription');
    var utterance = $(this).attr('utterance');

    add_word(transcription_id, utterance);
